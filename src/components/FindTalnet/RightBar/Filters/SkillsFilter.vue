<template>
    <div class="location">
        ...
        <div class="select">
            <p class="selected">{{optionSelected}}</p>
            <div class="options" v-if="optionsShow">
                <p @click="selectOption('Html5')">Html5</p>
                <p @click="selectOption('Css3')">Css3</p>
                <p @click="selectOption('JavaScript')">JavaScript</p>
            </div>
            <svg v-if="!optionsShow" @click="optionsShowToogle()" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script setup> 
import { ref } from 'vue'
const optionSelected = ref("" || "Skills")
const optionsShow = ref(false)
function optionsShowToogle(){
